...
namespace SimpleInjector
{
    ...
    {
        public static void RegisterWithContext<TService>(this Container container, Func<DependencyContext, TService> contextBasedFactory) where TService : class
        {
        ...
        private sealed class DependencyContextRewriter : ExpressionVisitor
        {
            ...
            private bool IsRootedContextBasedFactory(InvocationExpression node)
            {
                ...
                return ReferenceEquals(expression.Value, this.RootFactory);
            }
        }
    }
}